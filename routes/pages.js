...
const {isEducator,isOwner,isEnrolled} = require("../middleware.js");
//show pages
router.get("/",connectEnsureLogin.ensureLoggedIn(),isEnrolled,pageController.getPages);
//add pages
router.get("/new",connectEnsureLogin.ensureLoggedIn(),pageController.getCreatePage);
//get particular page
router.get("/:PageId",connectEnsureLogin.ensureLoggedIn(),isEnrolled,pageController.getParticularPage);
